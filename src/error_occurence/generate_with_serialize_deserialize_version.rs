                ...
                fields_vec.into_iter().for_each(|(field_ident, error_or_code_occurence)|{
                    match error_or_code_occurence {
                        crate::error_occurence::error_or_code_occurence::ErrorOrCodeOccurence::Error {
                            ...
                            let field_type_with_serialize_deserialize_token_stream = match attribute {
                            ...
                            if &ident_with_serialize_deserialize_token_stream.to_string() == "KekwWithSerializeDeserialize" {
                                println!("{field_type_with_serialize_deserialize_token_stream}");
                            }
...
fn generate_field_type_with_serialize_deserialize_version(
    ...
    does_not_support_stringified: &std::string::String,
    ...
    hashmap_value_type_reference_stringified: &std::string::String,
    ...
    hashmap_key_type_reference_stringified: &std::string::String,
    str_stringified: &str,
    attribute_vec_display_with_serialize_deserialize_stringified: &std::string::String,
    must_be_used_with_stringified: &std::string::String,
    string_string_stringified: std::string::String,
