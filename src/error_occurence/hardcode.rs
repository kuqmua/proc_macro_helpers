...
pub fn named_lower_case() -> std::string::String {
    crate::naming_conventions::ToSnakeCase::to_snake_case(&NAMED_CAMEL_CASE)
}
...
pub fn error_occurence_lower_case() -> std::string::String {
    crate::naming_conventions::ToSnakeCase::to_snake_case(&error_occurence_camel_case())
        .to_lowercase()
}
...
pub fn hashmap_lower_case() -> std::string::String {
    crate::naming_conventions::ToSnakeCase::to_snake_case(&HASHMAP_CAMEL_CASE)
}
